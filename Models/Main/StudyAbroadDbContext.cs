...
public partial class StudyAbroadDbContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
         ...
         => optionsBuilder.UseSqlServer("Server=DESKTOP-C8F8CM6;Database=StudyAbroad;MultipleActiveResultSets=true;User ID=sa;Password=asdasd;Trusted_Connection=True;TrustServerCertificate=Yes");
